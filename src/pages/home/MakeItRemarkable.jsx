...
const MakeItRemarkable = () => {
  return (
    <div className="bg-[#F8F5F2]">
      <div className="bg-[#E6F5F0] flex items-center md:rounded-t-[40px] lg:rounded-t-[80px] py-[4rem]">
        <div className="container mx-auto px-4 lg:px-8 flex flex-col md:flex-row items-center md:gap-[4rem] lg:gap-[8rem]">
