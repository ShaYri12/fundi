...
const CertifiedCompanies = () => {
  return (
    <section className="px-4 pb-[60px] md:pb-20 mt-10">
      <div className="max-w-[1440px] w-full mx-auto">
        ...
        <div className="flex items-center mx-auto justify-center gap-x-7 md:gap-x-14 gap-y-7 flex-wrap">
          <img src={Basiq} alt="Basiq logo" className="h-7 md:h-10 cursor-pointer" />
          <img src={Stripe} alt="Powered by Stripe logo" className="h-8 md:h-12 cursor-pointer" />
          <img src={Pcidas} alt="PCI DSS logo" className="h-8 md:h-12 cursor-pointer" />
        </div>
      </div>
    </section>
  );
